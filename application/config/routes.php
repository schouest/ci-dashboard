...
$route['changepassword/(:num)'] = 'dashboards/edit_pw/$1';
$route['updateinfo/(:num)'] = 'dashboards/edit_info/$1';
$route['updatedesc/(:num)'] = 'dashboards/edit_desc/$1';